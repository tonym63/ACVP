...
| ek | The encapsulation key when the `"function": "encapsulation" or "encapsulationKeyCheck"` | hex
| m | The random value used to derive the shared key when the `"function": "encapsulation"` | hex
| c | The cipher text when the `"function": "decapsulation"` | hex
|===
